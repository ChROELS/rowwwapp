...
public class ExcelView extends AbstractXlsView {
    ...
    protected void buildExcelDocument(Map<String, Object> map, Workbook workbook, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
        ...
        style.setFont(font);
        // create header row
        Row headerRower = sheet.createRow(0);
        header.createCell(0).setCellValue("Id");
        header.getCell(0).setCellStyle(style);
        header.createCell(1).setCellValue("Nom");
        header.getCell(1).setCellStyle(style);
        ...
        header.getCell(2).setCellStyle(style);
        header.createCell(3).setCellValue("Nationalité");
        header.getCell(3).setCellStyle(style);
        header.createCell(4).setCellValue("Genre");
        header.getCell(4).setCellStyle(style);
        header.createCell(5).setCellValue("Date de naissance");
        header.getCell(5).setCellStyle(style);
        header.createCell(6).setCellValue("Club");
        header.getCell(6).setCellStyle(style);
        header.createCell(7).setCellValue("Numéro de license");
        header.getCell(7).setCellStyle(style);
        header.createCell(8).setCellValue("Handicap physique");
        header.getCell(8).setCellStyle(style);
        header.createCell(9).setCellValue("Expérience");
        header.getCell(9).setCellStyle(style);
        header.createCell(10).setCellValue("Catégorie");
        header.getCell(10).setCellStyle(style);
        header.createCell(11).setCellValue("Age");
        header.getCell(11).setCellStyle(style);
        header.createCell(12).setCellValue("Handicap");
